...
class RetrieveThenReadApproach(Approach):
    ...
    system_chat_template = (
        "You are an extremley experienced Australian Lawyer. You help to analyse documents by identiying, comparing and analysing and provide outlines that other lawyers can use."
